define({ "api": [
  ...
  },
  {
    ...
    "error": {
      "fields": {
        ...
        "404: Contact userId does not exist": [
          {
            "group": "404: Contact userId does not exist",
            "type": "String",
            "optional": false,
            "field": "message",
  ...
  },
  {
    "type": "put",
    "url": "/contacts/:userId?",
    "title": "Request to update a contact",
    "name": "PutContacts",
    "group": "Contacts",
    "header": {
      "fields": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "success",
            "description": "<p>true when the contact is updated</p>"
          }
        ]
      }
    },
    "error": {
      "fields": {
        ...
        "400: No contact relationship": [
          {
            "group": "400: No contact relationship",
            "type": "String",
            "optional": false,
            "field": "message",
            "description": "<p>&quot;User is not a contact&quot;</p>"
        ...
        "400: Contact confirmed error": [
          {
            "group": "400: Contact confirmed error",
            "type": "String",
            "optional": false,
            "field": "message",
            "description": "<p>&quot;Contact is already verified&quot;</p>"
          }
        ],
        "400: SQL Error": [
          {
